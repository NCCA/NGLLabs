...
void NGLScene::paintGL()
{
  ...
  for(auto &s : m_collideObjects)
  {
    if(s.isColliding(m_sphere))
    {
         s.setColour(0.0f,0.0f,0.0f);
    }
  }
...
void NGLScene::keyPressEvent(QKeyEvent *_event)
{
  ...
  case Qt::Key_I : m_sphere.moveRelative(0.0f,s_moveAmmount,0.0f); break;
  case Qt::Key_O : m_sphere.moveRelative(0.0f,-s_moveAmmount,0.0f); break;
